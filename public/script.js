...
function createCommand(element, order, command, type, aliases) {
  ...
  label.classList.add(type === 'handleEvent' ? 'handleEvent' : 'commands');
...
function selectAllCommands() {
  ...
  box.forEach(({
    ...
    checkboxes.forEach((checkbox) => {
      ...
      const labelText = container.querySelector('.commands');
...
function selectAllEvents() {
  ...
  box.forEach(({
    ...
    checkboxes.forEach((checkbox) => {
      const container = checkbox.closest('.form-check');
      const checkBox = container.querySelector('.check-box');
      const labelText = container.querySelector('.handleEvent');
